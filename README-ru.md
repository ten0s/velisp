...
запускать DCL диалоги как обычные приложения на Windows, MacOS и Linux.
...
- [Реализованные функции](#implemented-functions)
- [Известные проблемы и ограничения](#known-issues-and-limitations)
- [Версия](#versioning)
- [Помощь](#contributing)
- [Лицензия](#license)
