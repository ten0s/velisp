...
1. Скачайте https://github.com/ten0s/velisp/releases/download/0.7.9/velisp-0.7.9-win-x64-setup.zip
2. Откройте папку Загрузки
3. Распакуйте velisp-0.7.9-win-x64-setup.zip
4. Запустите velisp-0.7.9-win-x64-setup.exe
...
1. Скачайте https://github.com/ten0s/velisp/releases/download/0.7.9/velisp-0.7.9-win-x64.zip
2. Откройте папку Загрузки
3. Выделите velisp-0.7.9-win-x64.zip
...
5. Выберите 'Edit...'
6. Выберите 'New...'
7. Введите 'C:\velisp-0.7.9-win-x64'
8. Выберите 'OK'
9. Выберите 'OK'
...
3. Выберите 'Add...'
4. Выберите 'Browse...'
5. Выберите C:\Program Files\VeLisp\examples или C:\velisp-0.7.9-win-x64\examples
6. Выберите 'OK'
7. Выберите 'Apply'
7. Выберите 'OK'
