...
| (vl-list->string char-codes-list) | Combines the characters associated with a list of integers into a string | Expected in v0.6.0 |
...
| (boundp sym) | Verifies whether a value is bound to a symbol | Expected in v0.6.0 |
