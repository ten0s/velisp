...
```
$ wget https://github.com/ten0s/velisp/releases/download/0.7.0-2/velisp-0.7.0-2-linux-x64
$ chmod +x velisp-0.7.0-2-linux-x64
```
...
```
$ ./velisp-0.7.0-2-linux-x64
VeLisp 0.7.0-2 on linux
...
```
$ ./velisp-0.7.0-2-linux-x64 examples/fib.lsp
55
```
...
```
$ ./velisp-0.7.0-2-linux-x64 examples/fib.lsp 11
89
```
...
```
$ ./velisp-0.7.0-2-linux-x64 examples/calc.lsp
```
...
```
$ ./velisp-0.7.0-2-linux-x64 examples/mines.lsp
```
...
```
$ ./velisp-0.7.0-2-linux-x64 examples/fifteen.lsp
```
...
```
$ cat examples/fib.lsp | ./velisp-0.7.0-2-linux-x64
55
```

```
$ cat examples/fib.lsp | ./velisp-0.7.0-2-linux-x64 -- 11
89
```

```
$ echo '(alert "Hello from VeLisp!")' | ./velisp-0.7.0-2-linux-x64
```

![Alert Hello From VeLisp Image](/images/alert-hello-velisp.png)

```
$ echo '(alert (strcat "Hello from " (argv 1) "!"))' | ./velisp-0.7.0-2-linux-x64 -- Arg
```
