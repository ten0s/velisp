...
**VeLisp** is AutoLISP interpreter with DCL support.<br>
The idea is to treat AutoLISP as a general purpose language.<br>
The goal is to run AutoLISP programs that don't use AutoCAD specific functionality.<br>
