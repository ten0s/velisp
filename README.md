...
```
$ ./velisp-0.6.6-linux-x64 examples/fib.lsp
55
```

```
$ ./velisp-0.6.6-linux-x64 examples/calc.lsp
```

![App Calc Image](/images/app-calc.png)

```
$ ./velisp-0.6.6-linux-x64 examples/mines.lsp
```
...
```
$ cat examples/fib.lsp | ./velisp-0.6.6-linux-x64
55
```

```
$ echo '(alert "Hi from VeLisp!")' | ./velisp-0.6.6-linux-x64
```
