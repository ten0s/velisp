...
var literalNames = [ null, "'@include'", "';'", "':'", "'{'", "'}'", "'dialog'", 
                     ...
                     "'concatenation'", "'radio_row'", "'radio_column'", 
                     "'boxed_radio_row'", "'boxed_radio_column'", "'button'", 
                     "'edit_box'", "'list_box'", "'popup_list'", "'radio_button'", 
                     "'slider'", "'spacer'", "'text'", "'toggle'", "'='" ];

var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, null, 
                      null, null, null, null, null, null, null, null, "BOOL", 
                      "INT", "REAL", "STR", "ALIGN", "LAYOUT", "ID", "COMMENT", 
...
VeDclParser.REAL = 28;
VeDclParser.STR = 29;
VeDclParser.ALIGN = 30;
VeDclParser.LAYOUT = 31;
VeDclParser.ID = 32;
VeDclParser.COMMENT = 33;
VeDclParser.LINE_COMMENT = 34;
VeDclParser.NEWLINE = 35;
VeDclParser.WHITESPACE = 36;
...
VeDclParser.prototype.clusterTile = function() {
    ...
    try {
        ...
        this.state = 112;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeDclParser.T__5) | (1 << VeDclParser.T__6) | (1 << VeDclParser.T__7) | (1 << VeDclParser.T__8) | (1 << VeDclParser.T__9) | (1 << VeDclParser.T__10) | (1 << VeDclParser.T__11) | (1 << VeDclParser.T__12) | (1 << VeDclParser.T__13) | (1 << VeDclParser.T__14))) !== 0))) {
...
VeDclParser.prototype.simpleTile = function() {
    ...
    try {
        ...
        this.state = 114;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeDclParser.T__15) | (1 << VeDclParser.T__16) | (1 << VeDclParser.T__17) | (1 << VeDclParser.T__18) | (1 << VeDclParser.T__19) | (1 << VeDclParser.T__20) | (1 << VeDclParser.T__21) | (1 << VeDclParser.T__22) | (1 << VeDclParser.T__23))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
VeDclParser.prototype.attributeValue = function() {
    ...
    try {
        ...
        this.state = 133;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeDclParser.BOOL) | (1 << VeDclParser.INT) | (1 << VeDclParser.REAL) | (1 << VeDclParser.STR) | (1 << VeDclParser.ALIGN) | (1 << VeDclParser.LAYOUT))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
