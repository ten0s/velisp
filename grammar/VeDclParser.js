...
var literalNames = [ null, "'@include'", "';'", "':'", "'{'", "'}'", "'dialog'", 
                     ...
                     "'edit_box'", "'radio_button'", "'slider'", "'spacer'", 
                     "'text'", "'toggle'", "'='" ];
...
VeDclParser.REAL = 26;
VeDclParser.STR = 27;
VeDclParser.ALIGN = 28;
VeDclParser.LAYOUT = 29;
VeDclParser.ID = 30;
VeDclParser.COMMENT = 31;
VeDclParser.LINE_COMMENT = 32;
VeDclParser.NEWLINE = 33;
VeDclParser.WHITESPACE = 34;
...
VeDclParser.prototype.simpleTile = function() {
    ...
    try {
        ...
        this.state = 114;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeDclParser.T__15) | (1 << VeDclParser.T__16) | (1 << VeDclParser.T__17) | (1 << VeDclParser.T__18) | (1 << VeDclParser.T__19) | (1 << VeDclParser.T__20) | (1 << VeDclParser.T__21))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
