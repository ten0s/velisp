...
var symbolicNames = [ null, null, null, null, null, null, null, null, null, 
                      ...
                      "BOOL", "INT", "REAL", "STR", "ALIGN", "ID", "COMMENT", 
...
VeDclParser.REAL = 20;
VeDclParser.STR = 21;
VeDclParser.ALIGN = 22;
VeDclParser.ID = 23;
VeDclParser.COMMENT = 24;
VeDclParser.LINE_COMMENT = 25;
VeDclParser.NEWLINE = 26;
VeDclParser.WHITESPACE = 27;
...
VeDclParser.prototype.simpleTile = function() {
    ...
    try {
        ...
        this.state = 114;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << VeDclParser.T__11) | (1 << VeDclParser.T__12) | (1 << VeDclParser.T__13) | (1 << VeDclParser.T__14) | (1 << VeDclParser.T__15))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
